...
const SocialMedia = () => {
  let seoTitle =
    "Social Media Management | Facebook, Instagram, LinkedIn | Good Program";
  let seoDesc =
    "Boost website traffic and get more conversions through integrated Facebook, Instagram and other social media platform marketing.";
  return (
    <Layout>
      <NextSeo
        title={seoTitle}
        description={seoDesc}
        openGraph={{
          url: "https://goodprogram.com.au/services/social-media",
          type: "website",
          title: seoTitle,
          description: seoDesc,
          images: [
